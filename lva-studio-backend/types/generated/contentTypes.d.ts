...
export interface ApiAdminAdmin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    admin_role: Schema.Attribute.Enumeration<
      ['Super Admin', 'Moderator', 'Manager']
    > &
      Schema.Attribute.DefaultTo<'Manager'>;
    can_change_roles: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    can_delete_members: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ribbon_role: Schema.Attribute.Enumeration<
      ['Super Admin', 'Admin', 'Moderator', 'Member']
    > &
